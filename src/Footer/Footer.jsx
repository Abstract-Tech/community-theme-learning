...
import { Card, Button, Carousel, Container, Row } from "@edx/paragon";
import "./Footer.scss";
    ...
    <footer>
      <div className="footer-container">
        <div className="colophon">
          <ul className="nav-colophon">
            {links?.map((data, index) => (
              <li key={index} className={"nav-colophon-0" + index}>
        ...
        <div class="privacy-items">
          <div class="flex icons space-x-6">
          ...
          <div className="privacy-links">
            <ul>
              <li>Name</li>|<li>All rights reserved </li>|<li>Privacy</li>|
              <li>Terms</li>
            </ul>
          </div>
        </div>
